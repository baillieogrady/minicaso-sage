<footer class="footer">
  <div class="container">
    <div class="row justify-content-between">
      <div class="col-lg-4">
        <p class="bold footer__heading">Contact Information</p>
        <div class="font-12">
          <a href="mailto:{{ the_field('email', 'options') }}" class="white tdn font-24">{{ the_field('email', 'options') }}</a>
        </div>
        <a class="footer__icon" href="https://www.facebook.com/weareminicaso" target="_blank">
      ...
      <div class="col-lg-3">
        <p class="bold footer__heading">Resources</p>
        <div class="font-12 footer__links">
    ...
    <div class="row justify-content-between align-items-center footer__bottom">
      <div class="col-lg-4">
        <p class="footer__copy">
          COPYRIGHT &copy; {{ date('Y') }} {{ strtoupper($site_name) }}
        </p>
      </div>
      <div class="col-lg-3">
